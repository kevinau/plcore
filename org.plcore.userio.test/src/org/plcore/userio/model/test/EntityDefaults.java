...
public class EntityDefaults extends ModelFactorySetup {
  ...
  public void classAssignedDefault () {
    ...
    Assertions.assertEquals("Initial and default value", nameItem.getValue());
  }
  ...
  public void defaultField () {
    ...
    IItemModel nameItem = model.selectItemModel("name");
    Assertions.assertEquals("Assigned value", nameItem.getValue());
    Assertions.assertEquals("Default value", nameItem.getDefaultValue());
  }
  ...
  public void dependentDefaultMethod () {
    ...
    IItemModel nameItem = model.selectItemModel("name");
    Assertions.assertEquals("Assigned name", nameItem.getValue());
    Assertions.assertEquals("Name 12", nameItem.getDefaultValue());
    
    // Make name item the same as the default value
    nameItem.setValue("Name 12");
    Assertions.assertEquals("Name 12", nameItem.getValue());
    ...
    Assertions.assertEquals("Name 34", nameItem.getValue());
    Assertions.assertEquals("Name 34", nameItem.getDefaultValue());    
  }
  ...
  public void multipleDependsAndAppliesTo () {
    ...
    IItemModel nameItem = model.selectItemModel("name");
    Assertions.assertEquals("Assigned value", nameItem.getValue());
    Assertions.assertEquals("Name 12-34", nameItem.getDefaultValue());
  }
