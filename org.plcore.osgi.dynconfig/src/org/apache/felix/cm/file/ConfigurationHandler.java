...
public class ConfigurationHandler
{
    ...
    protected static final Map<Class<?>, Object> type2Code;
    protected static final Map<Object, Class<?>> code2Type;
    ...
    static
    {
        ...
        for ( Iterator<Map.Entry<Class<?>, Object>> ti = type2Code.entrySet().iterator(); ti.hasNext(); )
        {
            Map.Entry<Class<?>, Object> entry = ti.next();
    ...
    public static void write( OutputStream out, Dictionary<String, Object> properties ) throws IOException
    {
        ...
        for ( Enumeration<String> ce = properties.keys(); ce.hasMoreElements(); )
        {
     ...
     */
    public static Dictionary<String, Object> read( InputStream ins ) throws IOException
    {
    ...
    private Dictionary<String, Object> readInternal( InputStream ins ) throws IOException
    {
