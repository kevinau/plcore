...
@Component(service = EntitySearchConfiguration.class, immediate = true)
public class EntitySearchConfiguration {
  ...
  private void activate() {
    componentConfigurer.activate(configAdmin, candidate -> candidate.getClass().getSimpleName() + "Search", (candidate, name, props) -> {
      props.put("name", name);
      
      // The daoName does not end with "Search".  The name passed (above) is suffixed with "Search".
