...
public @interface EmbeddedLabel {

  /**
   * A shortish heading that describes the group of fields. If not supplied it is
   * calculated from the field name using camel case conventions. This is hint
   * adds to the label.
   */
  ...
  /**
   * A description of the group of fields. This description adds to the understanding of
   * the group of fields.
   */
